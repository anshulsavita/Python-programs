...
# - index(pattern,[si],[ei]) --> return the index of specified index.
# this function generate exception(error) when given pattern does not exist
# - index(pattern,[si],[ei]) --> same as index but will not generate exception if pattern does not exist it will return -1
