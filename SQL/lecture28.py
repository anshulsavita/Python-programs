...
**** Aggregate function ****** 
min(col)
    --> will print minimum values
max(col)
    --> will print maximum values
sum(col) 
    --> will print sum 
avg(col) -->not include null
...
fild names
customer ID / CompanyName / ContactTitle / Address / Region / postalCode / Country / Phone /
